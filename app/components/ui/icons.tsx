...
export const Star = ({ className = "", filled = false, ...props }: IconProps) => (
  <svg
    className={className}
...
export const Flame = ({ className = "", ...props }: IconProps) => (
  <svg
    className={className}
    fill="none"
    height="24"
...
export const Heart = ({ className = "", filled = false, ...props }: IconProps) => (
  <svg
    className={className}
    fill={filled ? "currentColor" : "none"}
    height="24"
